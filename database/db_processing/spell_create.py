...
def new_spell(name, level, classes, desc):
    all_classes = ["class_wizard", "class_warlock", "class_sorcerer", "class_bard", "class_cleric", "class_druid",
                   "class_paladin", "class_artificer", "class_ranger", "class_warrior", "class_barbarian", "class_monk",
                   "class_rogue"]
    ...
    Spell.create(spell_name=name, level=level, class_wizard=chars[0], class_warlock=chars[1], class_sorcerer=chars[2],
                 ...
                 class_artificer=chars[7], class_ranger=chars[8], class_warrior=chars[9], class_barbarian=chars[10],
                 class_monk=chars[11], class_rogue=chars[12], description=desc)
